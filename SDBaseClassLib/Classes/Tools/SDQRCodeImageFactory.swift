...
public struct SDQRCodeImageFactory {
    ...
    public static func qrCodeImage(content: String,
        ...
        if let newLogoRoundCorner = logoRoundCorner, let roundCornerLogo = logo.sd.isRoundCorner(radius: newLogoRoundCorner, byRoundingCorners: .allCorners, imageSize: logoSize) {
