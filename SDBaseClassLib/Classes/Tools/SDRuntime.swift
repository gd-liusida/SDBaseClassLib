...
public func sd_getAssociatedObject<T>(_ object: Any, _ key: UnsafeRawPointer) -> T? {
    return objc_getAssociatedObject(object, key) as? T
}

public func sd_setRetainedAssociatedObject<T>(_ object: Any, _ key: UnsafeRawPointer, _ value: T, _ policy: objc_AssociationPolicy = .OBJC_ASSOCIATION_RETAIN_NONATOMIC) {
    objc_setAssociatedObject(object, key, value, policy)
}

// MARK:- 一、基本的方法
public class SDRuntime: NSObject {
    ...
    public static func getAllPropertyName(_ aClass: AnyClass) -> [String] {
        ...
        for i in 0 ..< intCount {
            ...
            guard let propertyName = NSString(utf8String: property_getName(property)) as String? else {
                SDPrint("Couldn't unwrap property name for \(property)")
                break
            }
