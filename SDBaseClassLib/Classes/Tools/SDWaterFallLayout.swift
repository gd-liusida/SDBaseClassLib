...
public protocol SDWaterFallLayoutDataSoure: class {
    func waterfall(_ waterfall: SDWaterFallLayout, item: Int) -> CGFloat
}

public class SDWaterFallLayout: UICollectionViewFlowLayout {
    /// 数据源
    public weak var dataSource: SDWaterFallLayoutDataSoure?
...
// MARK:- 准备布局
public extension SDWaterFallLayout {
    /// 准备
