...
// MARK:- 校验字符的表达式
public enum SDRegexCharacterType: String {
    /// 汉字
    case type1 = "^[\\u4e00-\\u9fa5]{0,}$"
...
// MARK:- 校验数字的表达式
public enum SDRegexDigitalType: String {
    /// 数字
    case type1 = "^[0-9]*$"
    /// 零和非零开头的数字
...
public struct SDRegexHelper {
    ...
    /// - Returns: 返回结果
    public static func validateTelephoneNumber(_ telNum: String, pattern: String = SDRegexDigitalType.type13.rawValue) -> Bool {
