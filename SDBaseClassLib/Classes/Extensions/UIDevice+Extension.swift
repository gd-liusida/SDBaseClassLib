...
extension UIDevice: SDPOPCompatible {}
// 这里只指屏幕类型
...
// MARK:- 一、基本的扩展
public extension SDPOP where Base: UIDevice {
    ...
    static func screenType() -> UIDeviceScreenType {
        let modelName = Base.sd.modelName
    ...
    static func isIphone5Screen() -> Bool {
        if Base.sd.screenType() == .IPHONE_5 {
            return true
        }
        return false
    }
    ...
    static func isIphone6Screen() -> Bool {
        if Base.sd.screenType() == .IPHONE_6 {
            return true
        }
        return false
    }
    ...
    static func isIphoneXScreen() -> Bool {
        if Base.sd.screenType() == .IPHONE_X || Base.sd.screenType() == .IPHONE_XS || Base.sd.screenType() == .IPHONE_XR || Base.sd.screenType() == .IPHONE_XS_Max ||  Base.sd.screenType() == .IPHONE_11 ||  Base.sd.screenType() == .IPHONE_11_PRO ||  Base.sd.screenType() == .IPHONE_11_PRO_MAX {
            return true
        }
        return false
    }
    ...
    static func isIphoneXSScreen() -> Bool {
        if Base.sd.screenType() == .IPHONE_XS || Base.sd.screenType() == .IPHONE_XR || Base.sd.screenType() == .IPHONE_XS_Max {
            return true
        }
        return false
    }
...
public extension SDPOP where Base: UIDevice {
    ...
    static var isJailbroken: Bool {
        ...
        let path = String(format: "/private/%@", String.sd.stringWithUUID() ?? "")
        do {
