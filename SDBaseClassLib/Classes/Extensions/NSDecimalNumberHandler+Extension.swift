 ...
 */
extension NSDecimalNumberHandler: SDPOPCompatible {}

/// 计算的类型
public enum SDDecimalNumberHandlerType: String {
    // 加
    case add
    // 减
    case subtracting
...
// MARK:- 一、基本的扩展
public extension SDPOP where Base: NSDecimalNumberHandler {
    ...
    static func isDivisible(value1: Any, value2: Any) -> Bool {
        ...
        let valueArray = value.sd.separatedByString(with: ".")
        // 没有小数代表是整除
    ...
    ///   - value2: 值
    /// - Returns: 计算结果
    static func calculation(type: SDDecimalNumberHandlerType, value1: Any, value2: Any) -> NSDecimalNumber {
...
public extension SDPOP where Base: NSDecimalNumberHandler {
    ...
    static func decimalNumberHandlerValue(type: SDDecimalNumberHandlerType ,value1: Any, value2: Any, roundingMode: NSDecimalNumber.RoundingMode, scale: Int16, raiseOnExactness exact: Bool, raiseOnOverflow overflow: Bool, raiseOnUnderflow underflow: Bool, raiseOnDivideByZero divideByZero: Bool) -> NSDecimalNumber {
