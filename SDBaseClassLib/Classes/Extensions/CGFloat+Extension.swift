...
extension CGFloat: SDPOPCompatible {}

// MARK:- 一、CGFloat 的基本转换
public extension SDPOP where Base == CGFloat {
    ...
    // MARK: 1.5、转 String
    /// 转 String
    var string: String { return String(self.base.sd.double) }
    
    // MARK: 1.6、转 NSNumber
    /// 转 NSNumber
    var number: NSNumber { return NSNumber(value: self.base.sd.double) }
