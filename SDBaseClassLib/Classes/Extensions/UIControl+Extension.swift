...
public extension SDPOP where Base: UIControl {
...
fileprivate extension UIControl  {
    ...
    private var hitTime: Double? {
        get { return sd_getAssociatedObject(self, &hitTimerKey) }
        set { sd_setRetainedAssociatedObject(self, &hitTimerKey, newValue, .OBJC_ASSOCIATION_ASSIGN) }
    }
    ...
    @objc func c_preventDoubleHit(_ base: UIControl)  {
        ...
        SDAsyncs.asyncDelay(hitTime ?? 1.0) {
        } _: {
