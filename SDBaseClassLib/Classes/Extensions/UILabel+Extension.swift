...
// MARK:- 二、其他的基本扩展
public extension SDPOP where Base: UILabel {
    ...
    func linesCountAndLinesContent(accordWidth: CGFloat, lineSpace: CGFloat, textSpace: CGFloat = 0.0, paraSpace: CGFloat = 0.0) -> (Int?, [String]?) {
        ...
        let contentDict = UILabel.sd.genTextStyle(text: t as NSString, linebreakmode: NSLineBreakMode.byCharWrapping, align: align, font: f, lineSpace: lineSpace, textSpace: textSpace, paraSpace: paraSpace)
        ...
        for line in lines {
            ...
            let lineString = t.sd.sub(start: lineRange.location, length: lineRange.length)
...
public extension SDPOP where Base: UILabel {
    ...
    func setRangeFontText(font: UIFont, range: NSRange) {
        let attributedString = base.attributedText?.sd.setRangeFontText(font: font, range: range)
    ...
    func setsetSpecificTextFont(_ text: String, font: UIFont) {
        let attributedString = base.attributedText?.sd.setSpecificTextFont(text, font: font)
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeTextColor(color: UIColor, range: NSRange) {
        let attributedString = base.attributedText?.sd.setSpecificRangeTextColor(color: color, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextColor(_ text: String, color: UIColor) {
        let attributedString = base.attributedText?.sd.setSpecificTextColor(text, color: color)
        base.attributedText = attributedString
    }
    ...
    func setTextLineSpace(_ space: CGFloat) {
        let attributedString = base.attributedText?.sd.setSpecificRangeTextLineSpace(lineSpace: space, alignment: base.textAlignment, range: NSRange.init(location: 0, length: base.text?.count ?? 0))
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeTextUnderLine(color: UIColor, stytle: NSUnderlineStyle = .single, range: NSRange) {
        let attributedString = base.attributedText?.sd.setSpecificRangeUnderLine(color: color, stytle: stytle, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextUnderLine(_ text: String, color: UIColor, stytle: NSUnderlineStyle = .single) {
        let attributedString = base.attributedText?.sd.setSpecificTextUnderLine(text, color: color, stytle: stytle)
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeDeleteLine(color: UIColor, range: NSRange) {
        let attributedString = base.attributedText?.sd.setSpecificRangeDeleteLine(color: color, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextDeleteLine(_ text: String, color: UIColor) {
        let attributedString = base.attributedText?.sd.setSpecificTextDeleteLine(text, color: color)
        base.attributedText = attributedString
    }
    ...
    func insertImage(imgName: String, imgBounds: CGRect = .zero, imgIndex: Int = 0) {
        ...
        let attributedString = base.attributedText?.sd.insertImage(imgName: imgName, imgBounds: imgBounds, imgIndex: imgIndex)
        base.attributedText = attributedString
    }
    ...
    func firstLineLeftEdge(_ edge: CGFloat) {
        let attributedString = base.attributedText?.sd.firstLineLeftEdge(edge)
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeBliqueness(inclination: Float = 0, range: NSRange) {
        let attributedString = base.attributedText?.sd.setSpecificRangeBliqueness(inclination: inclination, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextBliqueness(_ text: String, inclination: Float = 0) {
        let attributedString = base.attributedText?.sd.setSpecificTextBliqueness(text, inclination: inclination)
        base.attributedText = attributedString
    }
}
